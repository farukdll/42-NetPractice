...
<details>
  ...
  Because the mask of A and B is `255.255.255.0` the possible IP-adresses<br>
  of A1 are <br>`104.99.23.1 - 104.99.23.254`.<br>
  For C and D the mask is `255.255.0.0`,<br>
